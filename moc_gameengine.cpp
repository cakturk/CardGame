...
**
** Created: Wed Sep 22 16:27:28 2010
...
static const char qt_meta_stringdata_GameEngine[] = {
    "GameEngine\0"
};

const QMetaObject GameEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameEngine,
      qt_meta_data_GameEngine, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GameEngine::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameEngine))
